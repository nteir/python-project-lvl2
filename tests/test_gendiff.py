...
def test_format2_json_generate_diff():
    file1 = './tests/fixtures/nested_file1.json'
    file2 = './tests/fixtures/nested_file2.json'
    recieved = generate_diff(file1, file2, format='plain')
    expected = open('./tests/fixtures/format2_expected.txt').read()
    assert recieved == expected


def test_format2_yaml_generate_diff():
    file1 = './tests/fixtures/nested_file1.yml'
    file2 = './tests/fixtures/nested_file2.yml'
    recieved = generate_diff(file1, file2, format='plain')
    expected = open('./tests/fixtures/format2_expected.txt').read()
...
def test_format3_json_generate_diff():
    file1 = './tests/fixtures/nested_file1.json'
    file2 = './tests/fixtures/nested_file2.json'
    recieved = generate_diff(file1, file2, format='json')
    expected = open('./tests/fixtures/format3_expected.txt').read()
    assert recieved == expected


def test_format3_yaml_generate_diff():
    file1 = './tests/fixtures/nested_file1.yml'
    file2 = './tests/fixtures/nested_file2.yml'
    recieved = generate_diff(file1, file2, format='json')
    expected = open('./tests/fixtures/format3_expected.txt').read()
